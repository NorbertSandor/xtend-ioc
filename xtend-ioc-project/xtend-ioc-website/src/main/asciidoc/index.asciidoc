...
* Add the dependecy http://search.maven.org/#artifactdetails|com.erinors|xtend-ioc-core|{docVersion}|jar[com.erinors:xtend-ioc-core:{docVersion}] to the project.
